package com.retrofit.lk.retrofittest.view;
...
public class KbWithWordsCircleProgressBar extends View {
    ...
    private final int mTxtStrokeWidth = 15;
    ...
    public KbWithWordsCircleProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(Color.parseColor("#ffda44"));
